...
public class CaixaEconomica implements Banco {
     ...
     * Segundo a documentação da Caixa Economica (4-Beneficiario) 
     */
...
//    }
    ...
    private String DVCampoLivre(String aux) {
        ...
        /*
         1� PASSO 
         Aplicar o m�dulo 11, o primeiro d�gito da direita para a esquerda ser�
         multiplicado por 2, o segundo, por 3 e 
         assim sucessivamente at� o 9;
         */
        //2�Passo, Somar o resultado da multiplica��o: 
        System.out.println();
        int soma = 0;
        while (i < aux.length()) {
        ...
        /*
         ...
         pular o 3� PASSO, ou seja, o Total 
         da Soma dever� ser diminu�do diretamente do quociente, 
        ...
        /*
         4� PASSO 
         Subtrair o resto da divis�o de 11.
         Se o RESULTADO for maior que 9 (nove) o DV ser� 0 (zero), 
